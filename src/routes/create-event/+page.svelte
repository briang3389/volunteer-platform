<script>
	...
	let description = '';
	let eventIconUrl =
		'https://static.wixstatic.com/media/6296ce_663f07a068f840109737ad0fbebccd73~mv2.jpg/v1/fill/w_640,h_400,al_c,q_80,usm_0.66_1.00_0.01,enc_auto/6296ce_663f07a068f840109737ad0fbebccd73~mv2.jpg';
...
<div class="container mx-auto p-4">
	...
	<form on:submit|preventDefault={handleSubmit}>
		...
		<textarea class="border rounded w-full p-2" bind:value={description} rows="4" required
		></textarea>
		...
		<br />
		<button class="bg-blue-500 text-white px-4 py-2 mt-4 rounded hover:bg-blue-700" type="submit"
			>Create Event</button
		>
	</form>
